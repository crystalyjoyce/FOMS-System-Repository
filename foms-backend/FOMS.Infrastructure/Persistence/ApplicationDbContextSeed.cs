...
public static class ApplicationDbContextSeed
{
    public static async Task SeedSampleDataAsync(ApplicationDbContext context)
    {
        ...
        {
            new Client { Id = "TEST-001", ClientCode = "TEST-001", Name = "Test Client", BusinessName = "Test Company", ContactPerson = "Test Client", ContactNumber = "09000000001", Email = "test001@speedpay.test", Address = "Metro Manila", Status = "Active", CreditLimit = 500000, CurrentBalance = 40000, DateRegistered = "2026-01-01" },
        ...
        {
            new Invoice { Id = "INV-1001", InvoiceNo = "INV-1001", ClientId = "TEST-001", ClientName = "Test Client", BillingDate = DateTime.UtcNow.ToString("yyyy-MM-dd"), DueDate = DateTime.UtcNow.AddDays(5).ToString("yyyy-MM-dd"), FreightCharges = 22321.43m, Subtotal = 22321.43m, VatRate = 0.12, VatAmount = 2678.57m, TotalAmount = 25000.00m, AmountPaid = 0m, Balance = 25000.00m, PaymentStatus = "Unpaid", Description = "Logistics Services - Manila to Quezon City" },
            new Invoice { Id = "INV-1002", InvoiceNo = "INV-1002", ClientId = "TEST-001", ClientName = "Test Client", BillingDate = DateTime.UtcNow.ToString("yyyy-MM-dd"), DueDate = DateTime.UtcNow.AddDays(-2).ToString("yyyy-MM-dd"), FreightCharges = 13392.86m, Subtotal = 13392.86m, VatRate = 0.12, VatAmount = 1607.14m, TotalAmount = 15000.00m, AmountPaid = 0m, Balance = 15000.00m, PaymentStatus = "Unpaid", Description = "Warehouse Storage Fee" },
